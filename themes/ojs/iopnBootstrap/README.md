# IOPN fork of Bootstrap3 for OJS 3.0

A community-built theme for OJS 3.0 that implements Bootstrap 3 components, customized for the Illinois Open Publishing Network.
